...
class TelegraphText extends TelegraphTextException
{
    ...
    public function __set($name, $value)
    {
        switch ($name) {
            ...
            case 'text':
                if (strlen($value) > 500 || strlen($value) < 1) {
                    throw new TelegraphTextException('Некорректная длина текста. Введите текст длиной от 1 до 500 символов', '421421');
                    return;
                }
                return $this->storeText($this);
